    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col icons-top d-flex justify-content-end all-shadow">
          <a href="#"><Image class="icon-styles" src="media/Group.png" alt="group01" width="24px"/></a>
          <a href="#"><Image class="icon-styles" src="media/Subtract.svg" alt="group06" width="24px"/></a>
          <a href="#"><Image class="icon-styles" src="media/Group 280.png" alt="group02" width="24px"/></a>
          <a href="#"><Image class="icon-styles" src="media/Group 281.png" alt="group03" width="24px"/></a>
          <a href="#"><Image class="icon-styles" src="media/Group 279.png" alt="group04" width="24px"/></a>
        </div>
      </div>
    </div>
